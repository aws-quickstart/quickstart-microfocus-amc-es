...
* Meet and exceed your application reliability, availability, and serviceability requirements. Enterprise Server 7.0 enables you to deploy your applications into a scale-out architecture, providing even more improvements to your applications' availability, scalability, reliability, and performance.
